...
<body>
     ...
     <div class="navigation">
        ...
        <a href="HomeServlet"><i class="fas fa-video"></i> Post an Image</a>
        <a href="createArticle.jsp"><i class="fas fa-newspaper"></i> Post an Article</a>
    </div>

    <div class="container">
        <h1><i class="fas fa-video"></i> Post a Video</h1>
        <form action="CreateVideoServlet" method="post" enctype="multipart/form-data">
            <label for="videoTitle">Caption</label>
            <input type="text" id="caption" name="caption" required>
            
            <label for="videoFile">Upload Video</label>
            <input type="file" id="videoFile" name="filename" accept="video/*" required>
